...
EOF
            ...
            # https://github.com/rust-lang/rust/blob/1.84.0/src/bootstrap/src/core/build_steps/compile.rs#L363-L395
            # https://github.com/rust-lang/rust/blob/1.84.0/compiler/rustc_target/src/spec/crt_objects.rs
  ...
  for linker in "${linkers[@]}"; do
    ...
    # https://github.com/rust-lang/rust/blob/1.84.0/tests/run-make/thumb-none-qemu/example/.cargo/config.toml
    case "${linker}" in
      rust-lld) ;;
        ...
        case "${RUST_TARGET}" in
          ...
          arm*v7*hf | thumbv7*hf | armv7-*android* | arm-*-android* | thumbv7neon-*-android*)
            case "${RUST_TARGET}" in
              ...
              # https://github.com/rust-lang/rust/blob/1.84.0/compiler/rustc_target/src/spec/targets/armv7_linux_androideabi.rs#L27
              # https://github.com/rust-lang/rust/pull/33414
              # https://github.com/rust-lang/rust/blob/1.84.0/compiler/rustc_target/src/spec/targets/armv7_unknown_netbsd_eabihf.rs#L17
              *-android* | *-netbsd*) fp_arch='(VFPv3|VFPv3-D16)' ;;
              # https://github.com/rust-lang/rust/blob/1.84.0/compiler/rustc_target/src/spec/targets/thumbv7em_none_eabihf.rs#L36
