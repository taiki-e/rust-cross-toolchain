...
# Refs:
# - https://github.com/rust-lang/rust/blob/1.61.0/src/ci/docker/scripts/illumos-toolchain.sh
...
# https://github.com/rust-lang/rust/blob/1.61.0/src/ci/docker/scripts/illumos-toolchain.sh#L21
