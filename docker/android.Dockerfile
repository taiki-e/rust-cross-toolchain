...
# - https://github.com/rust-lang/rust/blob/1.61.0/src/ci/docker/host-x86_64/dist-android/Dockerfile
# - https://github.com/rust-lang/rust/blob/1.61.0/src/ci/docker/scripts/android-ndk.sh
